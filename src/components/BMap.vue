...
export default {
  ...
  methods: {
    ...
    initMarker (point) {
      var _this = this
      var myIcon = new BMap.Icon('http://langlang2go.oss-cn-shanghai.aliyuncs.com/icon/ditu5.svg', new BMap.Size(75, 118))
      var shadow = new BMap.Icon('http://langlang2go.oss-cn-shanghai.aliyuncs.com/icon/ditu5.svg', new BMap.Size(75, 118))
